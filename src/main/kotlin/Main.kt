...
fun Mandelbrot(d: Decart):Int{
    var maxIter = 1000
    var R = 4.0
    //var c = Complex(d.x.toDouble(), d.y.toDouble())
    //var z = Complex(0.0,0.0)
    var z = Complex(d.x.toDouble(), d.y.toDouble())
    var c = Complex(0.28, 0.0113)
    var iter = 0
...
fun draw_Mandelbrot(scope: DrawScope, scales: Scales) = runBlocking{
    launch {
